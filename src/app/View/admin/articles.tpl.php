...
<div class="span12">
		  <div class="row-fluid">
            ...
            <div>
                <form class="form-horizontal" action="<?php echo $view->Route('manage/articles') ?>" method="get">
				<fieldset>
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tbody>
                <?php $meun = $view->getConfig('article')['article_class'] ?>
                <?php foreach($ArticleList as $article): ?>
				<tr class="list-users">
					<td><?php echo $article['id'];?></td>
					<td><a href="<?php echo $view->Route('manage/article_my/'.$article['uid']);  ?>"><?php echo $article['author'];?></a></td>
					...
					<td>
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="javascript:if(confirm('确定吗？'))window.location='<?php echo $view->Route('manage/article_delete/'.$article['id']);?>'"><i class="icon-trash"></i> Delete</a></li>
